...
- [x] 2.1 Unit tests pass: `npm test` — e6e6c93
- [x] 2.2 Type checking passes: `npx astro check` — e6e6c93
- [x] 2.3 Linting passes: `npm run lint` — e6e6c93
...
- [x] 4.1 Type checking passes: `npx astro check` — 0339ce9
- [x] 4.2 Linting passes: `npm run lint` — 0339ce9
...
- [x] 5.1 Type checking passes: `npx astro check` — fe58164
- [x] 5.2 Linting passes: `npm run lint` — fe58164
- [x] 5.3 Unit tests pass: `npm test` — fe58164
...
- [x] 6.1 Type checking passes: `npx astro check` — a7a62bb
- [x] 6.2 Linting passes: `npm run lint` — a7a62bb
- [x] 6.3 Unit tests pass: `npm test` — a7a62bb
